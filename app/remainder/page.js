...
const remainder = () => {
    ...
    useEffect(() => {
        ...
        setremainders(JSON.parse(remainders))
    }, [])


    const deleteremainder = (title) => {
        let newremainders = remainders.filter(item => {
    ...
    const editremainder = (first) => { second }

    return (
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="text-2xl font-medium title-font mb-4 text-gray-900">Your Remainders</h1>
                    {remainders.length == 0 && <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Your Remainders Will Show Here! Please add a remainder by going to <Link href="/" className="hover:text-gray-900">HomePage</Link></p>}
                </div>
                            ...
                            <div className="h-full flex flex-col items-center text-center">
                                ...
                                <div className="w-full">
                                    ...
                                    <span className="inline-flex">
                                        <a className="text-gray-500 cursor-pointer" onClick={() => { deleteremainder(item.title) }}>
